...
map.getView().fit([-540863.874007, 7879766.579913, 1660250.955352, 10042321.733429], map.getSize());
    ...
    element: (() => {
        ...
        if (102 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso Cartografía y SIG<br />UPN-2025<br />Ing. Victor Enrique Mendoza Astopilco';
            }
